<!-- CLASSIFY: L0 -->
# vci-ucif2 —— ucif2-formalization-kernel 之公域 CI 影子引擎（SHADOW-CI-01 矩阵 · 业务线影子）

**意图**：公域影子：消费 ucif2 线 outbox/weave 公开件，跑公开校验与基准，发布摘要（私域内容永不进入）
...
- 引擎升级经 provision 车道（ci-control/provision/vci/vci-ucif2/）幂等下发。
